...
public class NaverApiHelper {
    ...
    protected String display = "&display=5"; // 필수여부(N) 기본값(10) 최대값(100)
    protected String start = "&start=5";     // 필수여부(N) 기본값(1) 최대값(1000)
    protected String sort = "&sort=dsc";    // 필수여부(N) 기본값(sim) , date , asc , dsc
